<template>
  <div class="auth_box">
    ...
    <div class="login">
      <img v-if=isLoggedIn src='../assets/images/icons/logout_icon.png' @click="logout()" alt="" class="login_icon">
      <img v-else src='../assets/images/icons/login_icon.png' @click="login()" alt="" class="login_icon">
